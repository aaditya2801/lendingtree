		...
		<tbody  border="1" bgcolor="green">
			<c:forEach items="${list}" var="loan">
				<tr>
					...
					<td><a
						href="MapToPickup" target="_blank">Map to pick Dept</a>
                        <a
						href="MapToVerification" target="_blank">Map to verif Dept</a>
                        <a
						href="MapToLegal" target="_blank">Map to legal Dept</a>
                    </td>
