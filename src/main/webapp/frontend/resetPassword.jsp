        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-8 col-md-8 col-sm-offset-8 col-sm-6">
                    <form action="resetPasswordValidation" method="post" class="form_horizontal">
                        <div class="form_icon"><i class="fa fa-user-circle"></i></div>
                        <h3 class="title">Forget Password: Please Answer Below Questions</h3>
                        <div class="form-group">
                            <span><p>Enter Password</p></span>
                            <input class="form-control" type="password" name="pass1" required />
                        </div>
                        <div class="form-group">
                            <span><p>Re Enter Password</p></span>
