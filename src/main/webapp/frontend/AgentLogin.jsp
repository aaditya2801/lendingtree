        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-8 col-md-8 col-sm-offset-8 col-sm-6">
                    <form action="agentLoginValidation" method="post" class="form_horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aid" placeholder="ENTER USERNAME">
                        </div>
                        <div class="form-group">
                        ...
                        <ul class="form-options">
                            <li><a href="AgentRegistration">New Agent? Please Register<i class="fa fa-arrow-right"></i></a></li>
                        </ul>
                    </form>
                </div>
            </div>
