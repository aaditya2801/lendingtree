        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-8 col-md-8 col-sm-offset-8 col-sm-6">
                    <form action="agentCreated" method="post" class="form_horizontal">
                        <h3 class="title">AGENT Registration</h3>
				...
				<div class="form-group">
                            ...
                            Agent Id: <input type="text" name="aid" placeholder="Enter AgentId" value="" required />
                        </div>
				<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            Department: <input type="text" name="dept" value="" placeholder="Enter Department" required/>
                        </div>
				<div class="form-group">
				Category:
                            <td><input type="radio" name="category" value="approval"    />Approval Agent
					    <input type="radio" name="category" value="loan_admin" />Loan Agent Admin
					    <input type="radio" name="category" value="pick_up"  />Pick up Agent
                        <input type="radio" name="category" value="verification_dept"/>Verification Agent
					    <input type="radio" name="category" value="legal_dept"  />Legal Agent</td>
                        </div>
                        <div class="form-group">
				...
				Secret Ques 3: <input type="text" name="scrtQue3" value="" placeholder="Your Favorite Actor" required />
                        ...
                        <ul class="form-options">
                            <li><a href="AgentLogin">Registered Agent?<i class="fa fa-arrow-right"></i></a></li>
                        </ul>
                    </form>
                </div>
            </div>
